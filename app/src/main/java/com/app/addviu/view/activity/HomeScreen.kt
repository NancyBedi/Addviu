...
class HomeScreen : BaseActivity(), View.OnClickListener, NavigationView.OnNavigationItemSelectedListener {
    ...
    override fun onResume() {
        ...
        if(sharedPrefsHelper?.get(IS_LOGIN,false)!!) {
            ...
            imageLoader.displayImage("https://addviu.com/storage/images/channels/Food Masala_1582567340_13511259285e540fac3d6ca.webP",userImage,roundProfilePic())
